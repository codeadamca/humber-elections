...
if( isset( $_FILES['photo'] ) )
{
  ...
  if( $_FILES['photo']['error'] == 0 )
  {
    ...
    set_message( 'Team member photo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Team member photo has been deleted' );
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="team_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
