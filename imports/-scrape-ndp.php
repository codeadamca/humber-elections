...
while( $next = strpos( $html, 'campaign-civics-list-image', $start ) and $counter < 500 )
{

  $firstQuote = $next + 50;
  $secondQuote = strpos( $html, '"', $next + 51 );
  ...
  $firstH2 = strpos( $html, 'campaign-civics-list-title', $start ) + 39;
