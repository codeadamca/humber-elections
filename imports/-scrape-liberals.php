...
while( $next = strpos( $html, 'data-background-src', $start ) and $counter < 500 )
{

  $firstQuote = $next + 21;
  $secondQuote = strpos( $html, '"', $next + 22 );

  $image =  substr( $html, $firstQuote, $secondQuote - $firstQuote );

  $start = $next +22; 
  
  $firstH2 = strpos( $html, 'name', $start ) + 6;
  $secondH2 = strpos( $html, '<', $firstH2 + 2 );
  
  $name = explode( ' ', substr( $html, $firstH2, $secondH2 - $firstH2 ) );
